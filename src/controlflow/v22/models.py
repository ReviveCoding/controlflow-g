...
def _critical_threshold(y: np.ndarray, probabilities: np.ndarray) -> tuple[float, dict[str, float]]:
    ...
    return -negative_threshold, {"critical_recall": recall, "false_positive_rate": fpr}
...
def train_models(
    *,
    ...
    report = {
        ...
        "threshold_rule": "CALIBRATION recall >= 0.95 then minimize FPR, break ties by highest threshold",
