...
from controlflow.v24.closure_receipt import verify_receipt
...
def verify_terminal(
    ...
    decision_path = root / "results/v24/qualification/gate_decision.json"
    decision = json.loads(decision_path.read_text(encoding="utf-8"))
    expected_status = "COMPLETE" if decision["all_passed"] else "V24_DEVELOPMENT_NO_GO"
    if (
    ...
    if (
        after
        and binding(root, root / "state/v24_qualification_manifest.json")["sha256"]
