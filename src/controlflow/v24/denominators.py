...
from controlflow.v24.admission import independent_counts
...
def recompute(
    ...
    *,
    ...
    if any(len(frame) != 600 or frame.case_id.duplicated().any() for frame in (runtime, truth, candidate, per_case)):
    ...
    contract = yaml.safe_load((root / "configs/v24/denominator_contract.yaml").read_text(encoding="utf-8"))["metrics"]
