...
def main() -> None:
    ...
    bundle_payload = {
        ...
        "training_report": _binding(model_dir / "training_report.json"),
        "dataset_manifest": _binding(ROOT / "state/v22_dataset_manifest.json"),
        "novelty_provenance": report["novelty"],
        ...
        "qwen_served_model": "controlflow-g-v22-qwen3-4b",
        ...
        "serving_config": _binding(ROOT / "configs/v22/serving.yaml"),
